...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'edit': 'Edit',
      'ftpServer': 'FTP 서버',
      'ftpServerConfigure': 'FTP 서버 설정',
      'ftpServerRunningSummary': '@port 포트에서 활성화됨 (@access)',
      'ftpServerDisabledSummary': '비활성화됨, 설정하려면 탭하세요',
      'ftpServerStartFailed': 'FTP 서버 시작에 실패했습니다',
      'ftpServerDialogTitle': 'FTP 서버 설정',
      'ftpServerPort': '포트',
      'ftpServerUsername': '사용자 이름',
      'ftpServerPassword': '비밀번호',
      'ftpServerEnable': 'FTP 서버 활성화',
      'ftpServerAllowReadWrite': '읽기/쓰기 허용',
      'ftpServerReadOnlyAccess': '해제하면 읽기 전용으로 유지됩니다',
      'ftpServerKeepScreenAwake': '서버 실행 중 화면 켜짐 유지',
      'ftpServerSave': '저장',
      'ftpServerCancel': '취소',
      'ftpServerInvalidPort': '올바른 포트(1-65535)를 입력하세요',
      'ftpServerPassivePoolSize': '패시브 풀 크기',
      'ftpServerPassiveTimeout': '패시브 타임아웃(초)',
      'ftpServerPassivePortStart': '패시브 포트 시작',
      'ftpServerPassivePortEnd': '패시브 포트 종료',
      'ftpServerInvalidPoolSize': '0보다 큰 풀 크기를 입력하세요',
      'ftpServerInvalidTimeout': '0초보다 큰 타임아웃을 입력하세요',
      'ftpServerInvalidPortRange': '유효한 포트 범위(시작 <= 끝)를 입력하세요',
      'ftpServerPoolExceedsRange': '풀 크기가 포트 범위를 초과합니다',
      'ftpServerAccessReadWrite': '읽기/쓰기',
      'ftpServerAccessReadOnly': '읽기 전용',
      ...
      'downloadAndUpdateBusy': '다운로드 및 업데이트 작업이 이미 실행 중입니다',
      'downloadAndUpdateQueued': '대기열에 추가됨',
      'downloadAndUpdateNoTask': '다운로드하거나 업데이트할 갤러리가 없습니다',
      'downloadAndUpdateAllCurrentFavcat': '현재 즐겨찾기 분류의 모든 갤러리 다운로드 및 업데이트',
      'downloadAndUpdateSelected': '선택한 갤러리 다운로드 및 업데이트',
      'useArchiveDownloadForNewGalleryOnly': '한 번도 다운로드하지 않은 갤러리에만 아카이브 다운로드 사용',
      ...
      'enableRpcMode': 'RPC 모드 사용',
      'enableRpcModeHint': 'HTTPS를 통해 외부 백엔드 서버로 요청을 처리합니다',
      'rpcServerAddress': 'RPC 서버 주소',
      'rpcServerAddressHint': '예: https://127.0.0.1:3210',
      'rpcServerProfile': 'RPC 서버 프로필',
      'rpcServerProfileHint': '로컬, LAN, 클라우드 프리셋을 선택하세요',
      'rpcProfileLocal': '로컬',
      'rpcProfileLan': 'LAN',
      'rpcProfileCloud': '클라우드',
      'rpcProfileCustom': '사용자 지정',
      'rpcAccessToken': 'RPC 액세스 토큰',
      'rpcAccessTokenHint': '백엔드 인증에 사용하는 Bearer 토큰',
      'allowSelfSignedCertificate': '자체 서명 인증서 허용',
      'allowSelfSignedCertificateHint': '신뢰할 수 있는 개인 서버를 설정할 때만 활성화하세요',
      'rpcBackendStatus': 'RPC 백엔드 상태',
      'rpcCapabilities': 'RPC 기능',
      'rpcCapabilitiesHint': '백엔드: %s | 버전: %s | 기능: %s',
      'rpcCapabilitiesEmpty': '백엔드가 기능 정보를 반환하지 않았습니다',
      'rpcBackendDisabled': 'RPC 모드가 비활성화되었습니다',
      'rpcBackendReachable': '백엔드에 연결할 수 있습니다',
      ...
      'timeoutRetryTimes': '타임아웃 재시도 횟수',
      'timeoutRetryTimesHint': '연결/수신 타임아웃 시 재시도 횟수, 0은 사용 안 함',
      'serverErrorRetryTimes': '서버 오류 재시도 횟수',
      'serverErrorRetryTimesHint': '5xx 또는 연결 오류 재시도 횟수, 403은 재시도하지 않음',
      ...
      'repairMissingImages': '누락된 이미지 복구',
      'repairMissingImagesHint': '길게 눌러 누락된 이미지를 검사하고 복구합니다',
      'noMissingImagesDetected': '누락된 이미지가 없습니다',
      ...
      'smartScalingHint': '화면을 조금 넘는 이미지를 전체가 보이도록 축소합니다',
      'smartScalingThreshold': '화면 맞춤 기준',
      'smartScalingThresholdHint': '화면에 맞게 축소할 최대 추가 크기 비율',
      ...
      'filter': '필터',
      'downloadFilterIncludeTags': '태그',
      'downloadFilterIncludeTagsHint': '쉼표 또는 줄바꿈으로 구분하세요.',
      'downloadFilterGroups': '그룹',
      'downloadFilterCompletion': '상태',
      'downloadFilterNoMatch': '현재 필터와 일치하는 다운로드가 없습니다.',
      'tabBarName': '탭 이름',
      'quickSearchName': '이름',
