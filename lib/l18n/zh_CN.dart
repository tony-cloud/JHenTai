...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'downloadAndUpdateBusy': '下载并更新任务正在执行',
      'downloadAndUpdateQueued': '已加入队列',
      'downloadAndUpdateNoTask': '没有需要下载或更新的画廊',
      'downloadAndUpdateAllCurrentFavcat': '下载并更新当前收藏分类中的全部画廊',
      'downloadAndUpdateSelected': '下载并更新已选画廊',
      'useArchiveDownloadForNewGalleryOnly': '仅对从未下载的画廊使用归档下载',
      'resumeDownload': '继续下载',
      'pauseDownload': '暂停下载',
      ...
      'duplicateGalleryReview': '检查不同语言的重复下载',
      'duplicateGalleryReviewSettingHint': '按去除语言标记后的英文标题分组，确认后再清理',
      'duplicateGalleryReviewUnavailableInRpcMode': '请先更新 RPC 后端，再使用重复画廊检查',
      'duplicateGalleryReviewLoadFailed': '无法加载重复画廊分组。',
      'duplicateGalleryReviewEmpty': '没有发现英文标题相同的已下载画廊。',
      'duplicateGalleryReviewHint': '画廊按去除语言标记后的英文标题分组。点击画廊可进入阅读页比较，然后选择保留或删除。',
      'duplicateGalleryStats': '@size · @downloaded/@total 张图片 · @group · GID @gid',
      'duplicateGalleryChooseAction': '选择清理操作',
      'duplicateGalleryActionKeep': '保留',
      'duplicateGalleryActionDelete': '删除',
      'deleteAndUnfavorite': '删除并取消收藏',
      'duplicateGalleryApply': '执行清理',
      'duplicateGalleryRetry': '重试',
      'duplicateGalleryRefresh': '刷新',
      'duplicateGalleryConfirm': '确认',
      'duplicateGalleryConfirmTitle': '删除所选下载？',
      'duplicateGalleryConfirmMessage': '将删除 @delete 个下载，其中 @unfavorite 个也会取消收藏。',
      'duplicateGalleryCleanupResult': '已删除 @deleted 个，取消收藏 @unfavorited 个，失败 @failed 个。',
      ...
      'smartScaling': '智能缩放',
      'smartScalingHint': '略微超出屏幕的图片会缩放至全屏完整显示',
      'smartScalingThreshold': '适配屏幕阈值',
      'smartScalingThresholdHint': '图片超出屏幕不超过此比例时，会缩放至全屏显示',
      'turnPageMode': '翻页模式',
