...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'qrBlockSourceLabel': 'Source',
      'qrBlockSourceOnline': 'Search online',
      'qrBlockSourceDownloaded': 'Downloaded only',
      'qrBlockNoDownloadedMatch': 'No downloaded gallery matches the tag',
      ...
      'useBuiltInAdBlockListHint': 'Prevents @count known ad images',
      ...
      'longPress2Refresh': 'Long press to refresh',
      ...
      'enableRpcMode': 'Enable RPC Mode',
      'enableRpcModeHint': 'Use an external backend server over HTTPS for requests',
      'rpcServerAddress': 'RPC Server Address',
      'rpcServerAddressHint': 'Example: https://127.0.0.1:3210',
      'rpcServerProfile': 'RPC Server Profile',
      'rpcServerProfileHint': 'Choose a preset for local, LAN, or cloud deployment',
      'rpcProfileLocal': 'Local',
      'rpcProfileLan': 'LAN',
      'rpcProfileCloud': 'Cloud',
      'rpcProfileCustom': 'Custom',
      'rpcAccessToken': 'RPC Access Token',
      'rpcAccessTokenHint': 'Bearer token used for backend authentication',
      'allowSelfSignedCertificate': 'Allow Self-Signed Certificate',
      'allowSelfSignedCertificateHint': 'Enable only for trusted private servers during setup',
      'rpcBackendStatus': 'RPC Backend Status',
      'rpcCapabilities': 'RPC Capabilities',
      'rpcCapabilitiesHint': 'Backend: %s | Version: %s | Capabilities: %s',
      'rpcCapabilitiesEmpty': 'No capability metadata returned by backend',
      'rpcBackendDisabled': 'RPC mode is disabled',
      'rpcBackendReachable': 'Backend is reachable',
      'rpcBackendUnreachable': 'Backend is unreachable',
      'rpcHealthCheckSuccess': 'RPC backend is reachable',
      'rpcHealthCheckFailed': 'Failed to reach RPC backend',
      'rpcSettings': 'RPC Settings',
      'rpcSettingsHint': 'Configure external backend and embedded server',
      'embeddedRpcServer': 'Embedded RPC Server',
      'embeddedRpcServerHint':
      ...
      'embeddedRpcServerPortHint': 'Valid range: 1 - 65535',
      'embeddedRpcServerToken': 'Embedded Server Token',
      'embeddedRpcServerTokenHint': 'Used by app and external clients as a bearer token',
      'rpcEmbeddedServerStatus': 'Embedded Server Status',
      'rpcEmbeddedServerDisabled': 'Embedded server is disabled',
      'rpcEmbeddedServerRunning': 'Embedded server is running',
      'rpcEmbeddedServerStarting': 'Embedded server is starting or restarting',
      ...
      'repairMissingImages': 'Repair Missing Images',
      ...
      'ftpServerConfigure': 'Configure FTP server',
      'ftpServerRunningSummary': 'Enabled on port @port (@access)',
      'ftpServerDisabledSummary': 'Disabled. Tap to configure.',
      'ftpServerStartFailed': 'Failed to start FTP server',
      'ftpServerDialogTitle': 'FTP Server Settings',
      'ftpServerPort': 'Port',
      'ftpServerUsername': 'Username',
      'ftpServerPassword': 'Password',
      'ftpServerEnable': 'Enable FTP Server',
      'ftpServerAllowReadWrite': 'Allow Read/Write Access',
      'ftpServerReadOnlyAccess': 'Turn off for read-only access',
      'ftpServerKeepScreenAwake': 'Keep screen awake while the server is running',
      'ftpServerSave': 'Save',
      'ftpServerCancel': 'Cancel',
      'ftpServerInvalidPort': 'Enter a valid port (1-65535)',
      'ftpServerPassivePoolSize': 'Passive pool size',
      'ftpServerPassiveTimeout': 'Passive timeout (s)',
      'ftpServerPassivePortStart': 'Passive port start',
      'ftpServerPassivePortEnd': 'Passive port end',
      'ftpServerInvalidPoolSize': 'Enter a pool size greater than 0',
      'ftpServerInvalidTimeout': 'Enter a timeout greater than 0 seconds',
      'ftpServerInvalidPortRange': 'Enter a valid port range (start <= end)',
      'ftpServerPoolExceedsRange': 'Pool size exceeds available ports in range',
      'ftpServerAccessReadWrite': 'Read & Write',
      'ftpServerAccessReadOnly': 'Read Only',
      'ftpServerChangesApplied': 'Changes apply immediately',
      ...
      'filter': 'Filter',
      'downloadFilterIncludeTags': 'Tags',
      'downloadFilterIncludeTagsHint': 'Separate with commas or new lines.',
      'downloadFilterGroups': 'Groups',
      'downloadFilterCompletion': 'Status',
      'downloadFilterNoMatch': 'No downloads match current filters.',
