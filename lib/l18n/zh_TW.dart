...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'ftpServer': 'FTP伺服器',
      'ftpServerConfigure': '設定FTP伺服器',
      'blockedImageListManageHint': '在對話框中管理自訂哈希',
      'customHashHint': '哈希字串',
      'manage': '管理',
      'externalHashFiles': '外部哈希檔案',
      'externalHashFilesHint': '透過 URL 載入外部哈希檔案',
      'externalHashFileMeta': '@count 個哈希 - @time 更新',
      'externalHashFileNever': '尚未更新',
      'addExternalHashFile': '新增外部哈希檔案',
      'externalHashFileUrlHint': '請輸入檔案 URL',
      'autoUpdateExternalHashFiles': '啟動時自動更新外部檔案',
      'autoUpdateExternalHashFilesHint': '啟動應用時刷新外部哈希檔案',
      'ftpServerRunningSummary': '已啟用，埠號@port（@access）',
      'ftpServerDisabledSummary': '未啟用，點擊設定',
      'ftpServerStartFailed': '啟動FTP伺服器失敗',
      'ftpServerDialogTitle': 'FTP伺服器設定',
      'ftpServerPort': '埠號',
      'ftpServerUsername': '使用者名稱',
      'ftpServerPassword': '密碼',
      'ftpServerEnable': '啟用FTP伺服器',
      'ftpServerAllowReadWrite': '允許讀寫存取',
      'ftpServerReadOnlyAccess': '關閉以維持唯讀存取',
      'ftpServerKeepScreenAwake': '伺服器運行時保持螢幕常亮',
      'ftpServerSave': '儲存',
      'ftpServerCancel': '取消',
      'ftpServerInvalidPort': '請輸入有效的埠號（1-65535）',
      'ftpServerPassivePoolSize': '被動連線池大小',
      'ftpServerPassiveTimeout': '被動連線逾時（秒）',
      'ftpServerPassivePortStart': '被動埠號起始',
      'ftpServerPassivePortEnd': '被動埠號結束',
      'ftpServerInvalidPoolSize': '請輸入大於0的連線池大小',
      'ftpServerInvalidTimeout': '請輸入大於0的逾時時間',
      'ftpServerInvalidPortRange': '請輸入有效的埠號範圍（起始<=結束）',
      'ftpServerPoolExceedsRange': '連線池大小超過埠號範圍',
      'ftpServerAccessReadWrite': '讀寫',
      'ftpServerAccessReadOnly': '唯讀',
      'ftpServerChangesApplied': '變更將立即生效',
      'home': "首頁",
      'gallery': "畫廊",
      'setting': '設定',
      ...
      'openHentaiVerseHint': '在內建瀏覽器中開啟HentaiVerse。',
      'adBlocker': '廣告封鎖',
      'blockImageByHash': '依雜湊封鎖圖片',
      'blockImageByHashHint': '使用圖片 hash 過濾已知廣告圖片',
      'blockImageByQrCode': '依二維碼封鎖圖片',
      'blockImageByQrCodeHint': '掃描並封鎖包含二維碼的圖片',
      'qrBlockFilterByTags': '僅在標籤符合時掃描 QR',
      'qrBlockFilterByTagsHint': '只有當畫廊標籤符合下方過濾器時才啟用 QR 封鎖。',
      'qrBlockFilterTagList': '標籤過濾器（每行一條）',
      'qrBlockFilterTagListHint': '格式：namespace:"pattern"。例：language:"chinese\$"',
      'qrBlockModeSetting': 'QR 封鎖模式',
      'qrBlockModeSettingHint': '選擇偵測到 QR 後要封鎖的範圍',
      ...
      'qrBlockGalleryCount': '畫廊數量',
      'qrBlockTailImageCount': '尾端掃描張數',
      'qrBlockSortLabel': '排序',
      'qrBlockSortRecent': '最新優先',
      'qrBlockSortOldest': '最舊優先',
      'qrBlockSortRating': '評分',
      'qrBlockSourceLabel': '掃描來源',
      'qrBlockSourceOnline': '線上搜尋',
      'qrBlockSourceDownloaded': '僅已下載',
      'qrBlockNoDownloadedMatch': '沒有符合標籤的已下載畫廊',
      'qrBlockModeLabel': '封鎖模式',
      'qrBlockModeNormal': '僅含 QR 的圖片',
      'qrBlockModeAdvanced': '第一個 QR 到最後一個 QR',
      'qrBlockModeSuper': '第一個 QR 到畫廊末尾',
      'qrBlockStop': '停止',
      'qrBlockStart': '開始',
      'qrBlockReady': '準備掃描',
      'qrBlockProgress': '畫廊 @gallery · 圖片 @image',
      'qrBlockTagEmpty': '請先輸入標籤或關鍵字',
      'qrBlockFinished': '已完成',
      'useBuiltInAdBlockList': '使用內建封鎖清單',
      'useBuiltInAdBlockListHint': '阻擋 @count 張已知廣告圖片',
      'blockedImageHandling': '被封鎖圖片處理方式',
      'blockedImageHandlingHint': '選擇被封鎖圖片的呈現方式',
      'blockedImageHandlingHide': '直接隱藏',
      'blockedImageHandlingPlaceholder': '顯示占位',
      'blockedImageTools': '二維碼快取工具',
      'blockedImageToolsHint': '二維碼快取：@count 筆',
      'removeAdsImages': '移除廣告圖片（僅雜湊）',
      'removeAdsImagesHint': '長按刪除已下載且因雜湊封鎖的圖片',
      'removeAdsImagesConfirm': '刪除所有因雜湊封鎖的已下載圖片？',
      'removeAdsImagesResult': '已刪除 @count 張圖片',
      'removeAdsImagesEmpty': '沒有可清理的雜湊封鎖圖片',
      'clearBlockedImages': '清空自訂雜湊',
      'clearQrCache': '清空二維碼快取',
      'blockedImageList': '自訂封鎖雜湊',
      'blockedImageListEmpty': '尚無自訂雜湊',
      'copyAllHashes': '複製全部雜湊',
      'blockedImageMessage': '已封鎖的圖片（可能是廣告）',
      'hashCount': '@count 個雜湊',
      'blockThisImage': '封鎖此圖片',
      'add': '新增',
      'close': '關閉',
      'clearBlockedImagesConfirm': '確定要清空所有自訂雜湊嗎？',
      'clearQrCacheConfirm': '確定要清空二維碼快取嗎？',
      'blockImageSuccess': '已加入封鎖清單',
      'blockImageFailed': '無法封鎖此圖片',
      'blockedImageReasonHash': '因自訂雜湊被封鎖',
      'blockedImageReasonBuiltIn': '因內建清單被封鎖',
      'blockedImageReasonQr': '因二維碼被封鎖',
      'copyHash': '複製雜湊',
      'unblockImage': '不再封鎖',
      'unblockImageSuccess': '已從封鎖清單移除',
      ...
      'downloadAndUpdateBusy': '下載並更新任務正在執行',
      'downloadAndUpdateQueued': '已加入佇列',
      'downloadAndUpdateNoTask': '沒有需要下載或更新的畫廊',
      'downloadAndUpdateAllCurrentFavcat': '下載並更新目前收藏分類中的全部畫廊',
      'downloadAndUpdateSelected': '下載並更新已選畫廊',
      'useArchiveDownloadForNewGalleryOnly': '僅對從未下載的畫廊使用歸檔下載',
      'resumeDownload': '繼續下載',
      'pauseDownload': '暫停下載',
      ...
      'enableRpcMode': '啟用RPC模式',
      'enableRpcModeHint': '透過HTTPS連線外部後端伺服器處理請求',
      'rpcServerAddress': 'RPC伺服器位址',
      'rpcServerAddressHint': '範例: https://127.0.0.1:3210',
      'rpcServerProfile': 'RPC伺服器設定',
      'rpcServerProfileHint': '選擇本機、區網或雲端預設',
      'rpcProfileLocal': '本機',
      'rpcProfileLan': '區域網路',
      'rpcProfileCloud': '雲端',
      'rpcProfileCustom': '自訂',
      'rpcAccessToken': 'RPC存取權杖',
      'rpcAccessTokenHint': '用於後端驗證的Bearer Token',
      'allowSelfSignedCertificate': '允許自簽名憑證',
      'allowSelfSignedCertificateHint': '僅在受信任的私有伺服器除錯時啟用',
      'rpcBackendStatus': 'RPC後端狀態',
      'rpcCapabilities': 'RPC能力',
      'rpcCapabilitiesHint': '後端: %s | 版本: %s | 能力: %s',
      'rpcCapabilitiesEmpty': '後端未回傳能力資訊',
      'rpcBackendDisabled': 'RPC模式尚未啟用',
      'rpcBackendReachable': '後端可連線',
      ...
      'repairMissingImages': '修復缺失的圖片',
      'repairMissingImagesHint': '長按檢查並修復所有缺失的圖片',
      'noMissingImagesDetected': '未發現缺失的圖片',
      'repairMissingImagesResult': '已修復@count張圖片（重命名@renamed張）。',
      ...
      'duplicateGalleryReview': '檢查不同語言的重複下載',
      'duplicateGalleryReviewSettingHint': '依移除語言標記後的英文標題分組，確認後再清理',
      'duplicateGalleryReviewUnavailableInRpcMode': '請先更新 RPC 後端，再使用重複畫廊檢查',
      'duplicateGalleryReviewLoadFailed': '無法載入重複畫廊群組。',
      'duplicateGalleryReviewEmpty': '沒有發現英文標題相同的已下載畫廊。',
      'duplicateGalleryReviewHint': '畫廊依移除語言標記後的英文標題分組。點擊畫廊可進入閱讀頁比較，再選擇保留或刪除。',
      'duplicateGalleryStats': '@size · @downloaded/@total 張圖片 · @group · GID @gid',
      'duplicateGalleryChooseAction': '選擇清理操作',
      'duplicateGalleryActionKeep': '保留',
      'duplicateGalleryActionDelete': '刪除',
      'deleteAndUnfavorite': '刪除並取消收藏',
      'duplicateGalleryApply': '執行清理',
      'duplicateGalleryRetry': '重試',
      'duplicateGalleryRefresh': '重新整理',
      'duplicateGalleryConfirm': '確認',
      'duplicateGalleryConfirmTitle': '刪除所選下載？',
      'duplicateGalleryConfirmMessage': '將刪除 @delete 個下載，其中 @unfavorite 個也會取消收藏。',
      'duplicateGalleryCleanupResult': '已刪除 @deleted 個，取消收藏 @unfavorited 個，失敗 @failed 個。',
      ...
      'smartScaling': '智慧縮放',
      'smartScalingHint': '略微超出螢幕的圖片會縮放至全螢幕完整顯示',
      'smartScalingThreshold': '適配螢幕門檻',
      'smartScalingThresholdHint': '圖片超出螢幕不超過此比例時，會縮放至全螢幕顯示',
      'turnPageMode': '翻頁模式',
      ...
      'filter': '篩選',
      'downloadFilterIncludeTags': '標籤',
      'downloadFilterIncludeTagsHint': '使用逗號或換行分隔。',
      'downloadFilterGroups': '群組',
      'downloadFilterCompletion': '狀態',
      'downloadFilterNoMatch': '沒有符合目前篩選條件的下載。',
      'tabBarName': '標籤欄名稱',
      'quickSearchName': '名稱',
