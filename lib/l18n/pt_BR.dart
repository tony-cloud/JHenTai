...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      'ftpServerConfigure': 'Configurar servidor FTP',
      'ftpServerRunningSummary': 'Ativado na porta @port (@access)',
      'ftpServerDisabledSummary': 'Desativado. Toque para configurar.',
      'ftpServerStartFailed': 'Falha ao iniciar o servidor FTP',
      'ftpServerDialogTitle': 'Configurações do servidor FTP',
      'ftpServerPort': 'Porta',
      'ftpServerUsername': 'Usuário',
      'ftpServerPassword': 'Senha',
      'ftpServerEnable': 'Ativar servidor FTP',
      'ftpServerAllowReadWrite': 'Permitir leitura/gravação',
      'ftpServerReadOnlyAccess': 'Desative para manter somente leitura',
      'ftpServerKeepScreenAwake': 'Manter a tela ligada enquanto o servidor estiver ativo',
      'ftpServerSave': 'Salvar',
      'ftpServerCancel': 'Cancelar',
      'ftpServerInvalidPort': 'Informe uma porta válida (1-65535)',
      'ftpServerPassivePoolSize': 'Tamanho do pool passivo',
      'ftpServerPassiveTimeout': 'Tempo limite passivo (s)',
      'ftpServerPassivePortStart': 'Porta inicial passiva',
      'ftpServerPassivePortEnd': 'Porta final passiva',
      'ftpServerInvalidPoolSize': 'Informe um tamanho de pool maior que 0',
      'ftpServerInvalidTimeout': 'Informe um tempo limite maior que 0 segundos',
      'ftpServerInvalidPortRange': 'Informe um intervalo de portas válido (início <= fim)',
      'ftpServerPoolExceedsRange': 'Tamanho do pool excede portas disponíveis no intervalo',
      'ftpServerAccessReadWrite': 'Leitura e gravação',
      'ftpServerAccessReadOnly': 'Somente leitura',
      'ftpServerChangesApplied': 'Alterações aplicadas imediatamente',
      'edit': 'Edit',
      ...
      'qrBlockSourceLabel': 'Fonte',
      'qrBlockSourceOnline': 'Pesquisar online',
      'qrBlockSourceDownloaded': 'Somente baixadas',
      'qrBlockNoDownloadedMatch': 'Nenhuma galeria baixada corresponde à tag',
      ...
      'unblockImage': 'Não bloquear mais',
      ...
      'rpcServerAddress': 'Endereço do servidor RPC',
      'rpcServerAddressHint': 'Exemplo: https://127.0.0.1:3210',
      'rpcServerProfile': 'Perfil do servidor RPC',
      'rpcServerProfileHint': 'Escolha um preset para local, LAN ou nuvem',
      'rpcProfileLocal': 'Local',
      'rpcProfileLan': 'LAN',
      'rpcProfileCloud': 'Nuvem',
      'rpcProfileCustom': 'Personalizado',
      'rpcAccessToken': 'Token de acesso RPC',
      'rpcAccessTokenHint': 'Token Bearer usado para autenticação no backend',
      'allowSelfSignedCertificate': 'Permitir certificado autoassinado',
      'allowSelfSignedCertificateHint':
          'Ative apenas em servidores privados confiáveis durante a configuração',
      'rpcBackendStatus': 'Status do backend RPC',
      'rpcCapabilities': 'Capacidades RPC',
      'rpcCapabilitiesHint': 'Backend: %s | Versão: %s | Capacidades: %s',
      'rpcCapabilitiesEmpty': 'Nenhuma capacidade foi retornada pelo backend',
      'rpcBackendDisabled': 'O modo RPC está desativado',
      'rpcBackendReachable': 'Backend acessível',
      ...
      'wakelockTimeLimitWhenReading': 'Limite de tempo da tela ativa',
      'wakelockTimeLimitWhenReadingHint':
          'Desativa o wakelock automaticamente após o período selecionado',
      ...
      'downloadFilterIncludeTagsHint': 'Separe com vírgulas ou quebras de linha.',
      'downloadFilterGroups': 'Grupos',
      'downloadFilterCompletion': 'Status',
      'downloadFilterNoMatch': 'Nenhum download corresponde aos filtros atuais.',
      ...
      'keepScreenOnWhileDownloading': 'Manter a tela ligada durante o download',
      'keepScreenOnWhileDownloadingHint':
          'Impedir que o dispositivo entre em repouso enquanto houver downloads',
