...
class StyleSetting with JHLifeCircleBeanWithConfigStorage implements JHLifeCircleBean {
  ...
  Rx<LayoutMode> layout = PlatformDispatcher.instance.views.first.physicalSize.width /
  ...
  LayoutMode actualLayout = PlatformDispatcher.instance.views.first.physicalSize.width /
              PlatformDispatcher.instance.views.first.devicePixelRatio <
          600
      ? LayoutMode.mobileV2
      : GetPlatform.isDesktop
  ...
  bool get isInV2Layout =>
      actualLayout == LayoutMode.mobileV2 || actualLayout == LayoutMode.tabletV2;
  ...
  void applyBeanConfig(String configString) {
    ...
    pageListMode.value = Map.from(map['pageListMode']
            ?.map((route, listModeIndex) => MapEntry(route, ListMode.values[listModeIndex])) ??
        {});
