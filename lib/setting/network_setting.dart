...
class NetworkSetting with JHLifeCircleBeanWithConfigStorage implements JHLifeCircleBean {
  ...
  void applyBeanConfig(String configString) {
    ...
    pageCacheMaxAge.value =
        Duration(milliseconds: map['pageCacheMaxAge'] ?? pageCacheMaxAge.value.inMilliseconds);
    cacheImageExpireDuration.value = Duration(
        milliseconds:
            map['cacheImageExpireDuration'] ?? cacheImageExpireDuration.value.inMilliseconds);
  ...
  Future<void> saveProxy(JProxyType proxyType, String proxyAddress, String? proxyUsername,
