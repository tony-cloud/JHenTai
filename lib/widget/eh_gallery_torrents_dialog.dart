        ...
        LoadingStateIndicator(
          ...
          errorWidgetBuilder: () => GestureDetector(
            ...
            child: Icon(Icons.refresh,
                size: 32, color: UIConfig.loadingStateIndicatorButtonColor(context)),
          ),
        ),
      ],
    ...
    return ListTile(
      ...
      title: InkWell(
        onTap: () => launchUrlString(
          torrent.torrentUrl
              .replaceFirst('https://exhentai.org/torrent', 'https://ehtracker.org/get'),
      ...
      subtitle: Row(
        children: [
          ...
          Text(torrent.peers.toString(),
              style: const TextStyle(fontSize: UIConfig.torrentDialogSubtitleTextSize)),
          const Icon(Icons.download, size: UIConfig.torrentDialogSubtitleIconSize)
              .marginOnly(left: 6),
          Text(torrent.downloads.toString(),
              style: const TextStyle(fontSize: UIConfig.torrentDialogSubtitleTextSize)),
          const Icon(Icons.attach_file, size: UIConfig.torrentDialogSubtitleIconSize)
              .marginOnly(left: 6),
          Text(torrent.size,
              style: const TextStyle(fontSize: UIConfig.torrentDialogSubtitleTextSize)),
      ...
      trailing: IconButton(
        ...
        onPressed: () =>
            FlutterClipboard.copy(torrent.magnetUrl).then((_) => toast('hasCopiedToClipboard'.tr)),
      ),
    );
  }
}
