    ...
    return Row(
      ...
      children: [
        if (widget.type == EHSearchConfigDialogType.update)
          IconButton(icon: const Icon(Icons.delete), onPressed: _handleDeleteConfig),
        if (widget.type == EHSearchConfigDialogType.filter)
          IconButton(icon: const Icon(Icons.refresh), onPressed: _resetAllConfig),
        ...
        Row(
          ...
          children: [
            _buildTag(
              ...
              onTap: () =>
                  setState(() => searchConfig.includeImageSet = !searchConfig.includeImageSet),
              onLongPress: () {
                setState(() {
                  searchConfig.disableAllCategories();
        ...
        Row(
          ...
          children: [
            _buildTag(
              ...
              onTap: () =>
                  setState(() => searchConfig.includeArtistCG = !searchConfig.includeArtistCG),
              onLongPress: () {
                setState(() {
                  searchConfig.disableAllCategories();
            ...
            _buildTag(
              ...
              onTap: () =>
                  setState(() => searchConfig.includeCosplay = !searchConfig.includeCosplay),
              onLongPress: () {
                setState(() {
                  searchConfig.disableAllCategories();
        ...
        Row(
          ...
          children: [
            _buildTag(
              ...
              onTap: () =>
                  setState(() => searchConfig.includeWestern = !searchConfig.includeWestern),
              onLongPress: () {
                setState(() {
                  searchConfig.disableAllCategories();
          ...
          children: [
            SizedBox(
              ...
              child: CupertinoTextField(
                ...
                onChanged: (value) =>
                    searchConfig.pageAtLeast = value.isEmpty ? null : int.parse(value),
              ),
            ),
            Text('to'.tr),
            SizedBox(
              ...
              child: CupertinoTextField(
                ...
                style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color),
                onChanged: (value) =>
                    searchConfig.pageAtMost = value.isEmpty ? null : int.parse(value),
              ),
            ),
          ],
        ),
