...
class EHAddTagDialog extends StatelessWidget {
    ...
    return AlertDialog(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () => launchUrlString('https://ehwiki.org/wiki/Gallery_Tagging',
  ...
  RichText highlightKeyword(
      BuildContext context, String rawText, String currentKeyword, bool isSubTitle) {
...
class EHAddTagDialogLogic extends GetxController {
  ...
  Future<void> searchTags() async {
    ...
    if (state.useTranslation && tagTranslationService.isReady) {
      ...
      try {
        List<EHRawTag> tags =
            await ehRequest.requestTagSuggestion(lastKeyWord, EHSpiderParser.tagSuggestion2TagList);
            ...
            .map((t) => (
                  ...
                  namespaceMatch: t.namespace.contains(lastKeyWord)
                      ? (
                          ...
                          end: t.namespace.indexOf(lastKeyWord) + lastKeyWord.length
                        )
                      : null,
