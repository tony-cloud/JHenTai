...
class EHGalleryCategoryTag extends StatelessWidget {
  ...
  const EHGalleryCategoryTag({
    ...
    this.textStyle =
        const TextStyle(height: 1, fontSize: 15, color: UIConfig.galleryCategoryTagTextColor),
    this.onTap,
    this.onLongPress,
    this.onSecondaryTap,
  });
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: enabled
              ? textStyle
              : textStyle.copyWith(color: UIConfig.galleryCategoryTagDisabledTextColor(context)),
        ),
      ),
    );
  }
