...
class EHGalleryListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget child = FadeIn(
      ...
      child: SizedBox(
        ...
        child: listMode == ListMode.flat || listMode == ListMode.flatWithoutTags
  ...
  Widget buildGalleryCardCover(BuildContext context) {
    return EHImage(
      ...
      containerHeight:
          withTags ? UIConfig.galleryCardHeight : UIConfig.galleryCardHeightWithoutTags,
      containerWidth:
          withTags ? UIConfig.galleryCardCoverWidth : UIConfig.galleryCardCoverWidthWithoutTags,
  ...
  Widget _buildDownloadIcon(BuildContext context) =>
      Icon(Icons.downloading, size: 11, color: UIConfig.galleryCardTextColor(context));
