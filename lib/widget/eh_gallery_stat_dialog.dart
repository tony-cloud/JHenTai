          ...
          successWidgetBuilder: () => Column(
            children: [
              ...
              if (graphType == GraphType.allTime)
                FadeIn(key: const Key('1'), child: _AllTimeTable(galleryStats: galleryStats)),
              if (graphType == GraphType.year)
                FadeIn(
                    key: const Key('2'), child: _LineGraph(datasource: galleryStats.yearlyStats)),
              if (graphType == GraphType.month)
                FadeIn(
                    key: const Key('3'), child: _LineGraph(datasource: galleryStats.monthlyStats)),
              if (graphType == GraphType.day)
                FadeIn(key: const Key('4'), child: _LineGraph(datasource: galleryStats.dailyStats)),
            ],
          ),
          ...
          rows: <DataRow>[
            ...
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(
                        galleryStats.yearRanking == null ? '-' : '#${galleryStats.yearRanking}'))),
                DataCell(Center(
                    child: Text(
                        galleryStats.yearScore == null ? '-' : galleryStats.yearScore.toString()))),
              ],
            ),
            DataRow(
              cells: <DataCell>[
            ...
            DataRow(
              cells: <DataCell>[
                ...
                DataCell(Center(
                    child: Text(
                        galleryStats.dayRanking == null ? '-' : '#${galleryStats.dayRanking}'))),
                DataCell(Center(
                    child: Text(
                        galleryStats.dayScore == null ? '-' : galleryStats.dayScore.toString()))),
              ],
            ),
          ],
        ).marginOnly(top: 4),
