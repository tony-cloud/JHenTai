...
import 'package:jhentai/database/dao/dio_cache_dao.dart';
...
class EHCacheManager extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    ...
    CacheResponse? cacheResponse =
        await _getCacheStore(cacheOptions).get(CacheOptions.defaultCacheKeyBuilder(options));
  ...
  Future<CacheResponse> _updateCacheResponse(
    ...
    CacheResponse newCacheResponse =
        cacheResponse.copyWith(expireDate: DateTime.now().add(cacheOptions.expire));
