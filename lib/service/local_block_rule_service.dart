...
import 'package:jhentai/database/dao/block_rule_dao.dart';
...
class LocalBlockRuleService with JHLifeCircleBeanErrorCatch implements JHLifeCircleBean {
  ...
  LocalBlockRuleHandler getHandlerByRule(LocalBlockRule rule) =>
      handlers.where((h) => h.matchRule(rule)).sorted((a, b) => a.order - b.order).first;
...
class GalleryTagEqualLocalBlockRuleHandler extends EqualLocalBlockRuleHandler<Gallery>
...
class GalleryTitleLikeLocalBlockRuleHandler extends LikeLocalBlockRuleHandler<Gallery>
    with GalleryTitleAttributeGetter {}

class GalleryTagLikeLocalBlockRuleHandler extends LikeLocalBlockRuleHandler<Gallery>
    with GalleryTagAttributeGetter {}
...
class GalleryTagRegexLocalBlockRuleHandler extends RegexLocalBlockRuleHandler<Gallery>
    with GalleryTagAttributeGetter {}
...
enum LocalBlockAttributeEnum {
  ...
  static List<LocalBlockAttributeEnum> withTarget(LocalBlockTargetEnum? target) =>
