...
class DownloadSearchPage extends StatelessWidget {
    ...
    return GetBuilder<SuperResolutionService>(
      ...
      builder: (_) {
        SuperResolutionInfo? superResolutionInfo =
            superResolutionService.get(gallery.gid, SuperResolutionType.gallery);
  ...
  Widget _buildArchiveSuperResolutionLabel(BuildContext context, ArchiveSearchVO archive) {
    return GetBuilder<SuperResolutionService>(
      ...
      builder: (_) {
        SuperResolutionInfo? superResolutionInfo =
            superResolutionService.get(archive.gid, SuperResolutionType.archive);
  ...
  Widget _buildArchiveDownloadProgressText(
      ArchiveSearchVO archive, ArchiveDownloadInfo? archiveDownloadInfo, BuildContext context) {
