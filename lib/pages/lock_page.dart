...
class _LockPageState extends State<LockPage> with WindowListener, WindowWidgetMixin {
          ...
          child: ColoredBox(
            ...
            child: Column(
              ...
              children: [
                ...
                if (securitySetting.enableBiometricAuth.isTrue)
                  IconButton(
                          onPressed: biometricAuth, icon: const Icon(Icons.fingerprint, size: 40))
                      .marginOnly(top: 24),
              ],
            ),
          ),
  ...
  Future<void> biometricAuth() async {
    bool success = await LocalAuthentication().authenticate(
      /**
       * @see [local_auth_windows example](https://github.com/flutter/packages/local_auth/local_auth_windows/example/lib/main.dart)
       */
