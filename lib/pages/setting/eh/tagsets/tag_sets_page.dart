...
import 'package:jhentai/pages/setting/eh/tagsets/tag_sets_page_logic.dart';
    ...
    return AppBar(
      ...
      title: GetBuilder<TagSetsLogic>(
        ...
        builder: (_) => Text(state.tagSets.isEmpty
            ? 'myTags'.tr
            : state.tagSets.firstWhere((t) => t.number == state.currentTagSetNo).name),
      ),
      actions: [
      ...
      builder: (_) => LoadingStateIndicator(
        ...
        successWidgetBuilder: () => IconButton(
          icon: Icon(
            Icons.circle,
            color:
                state.currentTagSetBackgroundColor ?? UIConfig.ehWatchedTagDefaultBackGroundColor,
          ),
          onPressed: () async {
