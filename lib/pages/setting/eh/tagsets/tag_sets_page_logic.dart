  ...
  Future<void> deleteTag(int tagSetIndex) async {
    ...
    try {
      await ehRequest.requestDeleteWatchedTag(
          watchedTagId: state.tags[tagSetIndex].tagId, tagSetNo: state.currentTagSetNo);
    } on DioException catch (e) {
        ...
        actions: <CupertinoActionSheetAction>[
          CupertinoActionSheetAction(
            child: Row(
              ...
              children: [
                Icon(Icons.favorite, color: UIConfig.tagSetsPageIconDefaultColor(context))
                    .marginOnly(right: 4),
          ...
          CupertinoActionSheetAction(
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.not_interested, color: UIConfig.tagSetsPageIconDefaultColor(context))
                    .marginOnly(right: 4),
