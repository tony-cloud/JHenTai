...
import 'package:jhentai/pages/setting/account/login/login_page_logic.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LoginPageLogic>(
      builder: (_) => Scaffold(
        ...
        appBar: AppBar(
            backgroundColor: UIConfig.loginPageBackgroundColor(context),
            leading: BackButton(color: UIConfig.loginPageForegroundColor(context))),
        body: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const _TopArea(),
            Text('EHenTai',
                style: TextStyle(color: UIConfig.loginPageForegroundColor(context), fontSize: 60)),
            _buildForm(context),
          ],
        ),
      ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              IconTextButton(
                icon:
                    Icon(Icons.paste, size: 22, color: UIConfig.loginPagePrefixIconColor(context)),
                text: Text('parse'.tr,
                    style: const TextStyle(fontSize: UIConfig.loginPageParseCookieTextSize)),
  ...
  Widget _buildButtons(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        IconTextButton(
          width: 56,
          icon: Icon(state.loginType == LoginType.password ? Icons.cookie : Icons.face,
