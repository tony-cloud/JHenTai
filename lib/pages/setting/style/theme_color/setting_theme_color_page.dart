...
import 'package:jhentai/pages/setting/style/theme_color/preview_page/detail_preview_page.dart';
          ...
          Expanded(
            child: Row(
              ...
              children: [
                IconButton(
                  icon:
                      Icon(selectedBrightness == Brightness.light ? Icons.sunny : Icons.nightlight),
                  onPressed: () {
                    setState(() => selectedBrightness = selectedBrightness == Brightness.light
                        ? Brightness.dark
                        : Brightness.light);
                  },
                ),
