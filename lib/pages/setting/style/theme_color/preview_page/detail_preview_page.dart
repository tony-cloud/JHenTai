  ...
  Widget buildActions(BuildContext context) {
    return SliverPadding(
      padding: const EdgeInsets.only(
          top: 20, left: UIConfig.detailPagePadding, right: UIConfig.detailPagePadding),
        ...
        child: SizedBox(
          ...
          child: LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) => ListView(
              ...
              itemExtent:
                  max(UIConfig.detailsPageActionExtent, (constraints.maxWidth - 15 * 2) / 9),
              ...
              children: [
                ...
                IconTextButton(
                  icon:
                      Icon(Icons.saved_search, color: UIConfig.detailsPageActionIconColor(context)),
                  text: Text(
                    'similar'.tr,
                    style: TextStyle(
                      fontSize: UIConfig.detailsPageActionTextSize,
                ...
                IconTextButton(
                  icon:
                      Icon(Icons.file_present, color: UIConfig.detailsPageActionIconColor(context)),
                  text: Text(
