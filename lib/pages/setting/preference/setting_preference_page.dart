        ...
        () => SafeArea(
          child: ListView(
            ...
            children: [
              ...
              if (styleSetting.isInV2Layout || styleSetting.actualLayout == LayoutMode.desktop)
              ...
              if (preferenceSetting.showComments.isTrue)
                _buildShowAllComments().fadeInWidget(const Key('showAllComments')),
              ...
              if (preferenceSetting.enableTagZHTranslation.isTrue)
                _buildShowR18GImageDirectly().fadeInWidget(const Key('showR18GImageDirectly')),
              _buildShowUtcTime(),
              _buildShowDawnInfo(),
  ...
  Widget _buildTagOrderOptimization() {
    return ListTile(
      ...
      subtitle: tagSearchOrderOptimizationService.loadingState.value == LoadingState.success
          ? Text('${'version'.tr}: ${tagSearchOrderOptimizationService.version.value!}',
              style: const TextStyle(fontSize: 12))
        ...
        children: [
          ...
          Switch(
            ...
            onChanged: (value) {
              ...
              if (value == true &&
                  tagSearchOrderOptimizationService.loadingState.value != LoadingState.success) {
