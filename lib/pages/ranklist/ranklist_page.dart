        ...
        PopupMenuButton(
          ...
          itemBuilder: (BuildContext context) => <PopupMenuEntry<RanklistType>>[
            PopupMenuItem<RanklistType>(
                value: RanklistType.allTime, child: Center(child: Text('allTime'.tr))),
            PopupMenuItem<RanklistType>(
                value: RanklistType.year, child: Center(child: Text('year'.tr))),
            PopupMenuItem<RanklistType>(
                value: RanklistType.month, child: Center(child: Text('month'.tr))),
            PopupMenuItem<RanklistType>(
                value: RanklistType.day, child: Center(child: Text('day'.tr))),
          ],
        ),
      ],
    );
