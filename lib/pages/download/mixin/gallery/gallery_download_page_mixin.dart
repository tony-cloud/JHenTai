...
mixin GalleryDownloadPageMixin on StatelessWidget
  ...
  List<Widget> buildBottomAppBarButtons() {
    return [
      IconButton(
          icon: const Icon(Icons.done_all), onPressed: galleryDownloadPageLogic.selectAllItem),
      IconButton(
          icon: const Icon(Icons.play_arrow),
          onPressed: galleryDownloadPageLogic.handleMultiResumeTasks),
      IconButton(
          icon: const Icon(Icons.pause), onPressed: galleryDownloadPageLogic.handleMultiPauseTasks),
      IconButton(
      ...
      IconButton(
          icon: const Icon(Icons.delete), onPressed: galleryDownloadPageLogic.handleMultiDelete),
      const Expanded(child: SizedBox()),
      IconButton(
          icon: const Icon(Icons.close), onPressed: multiSelectDownloadPageLogic.exitSelectMode),
    ];
  }
}
