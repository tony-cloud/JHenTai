...
class GalleryGridDownloadPage extends StatelessWidget
  ...
  final GalleryGridDownloadPageLogic logic =
      Get.put<GalleryGridDownloadPageLogic>(GalleryGridDownloadPageLogic(), permanent: true);
  @override
            ...
            (gallery) => GetBuilder<GalleryDownloadService>(
              ...
              builder: (_) => GetBuilder<GalleryDownloadService>(
                ...
                builder: (_) {
                  ...
                  if (logic.downloadService.galleryDownloadInfos[gallery.gid]?.downloadProgress
                          .downloadStatus ==
  ...
  GridGallery galleryBuilder(BuildContext context, GalleryDownloadedData gallery, bool inEditMode) {
    return GridGallery(
      ...
      onLongPress:
          inEditMode ? null : () => logic.handleLongPressOrSecondaryTapItem(gallery, context),
      onSecondTap:
          inEditMode ? null : () => logic.handleLongPressOrSecondaryTapItem(gallery, context),
  ...
  GestureDetector _buildActionButton(GalleryDownloadedData gallery,
      GalleryDownloadProgress downloadProgress, GalleryDownloadSpeedComputer speedComputer) {
