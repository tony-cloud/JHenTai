...
class ArchiveGridDownloadPage extends StatelessWidget
  ...
  final ArchiveGridDownloadPageLogic logic =
      Get.put<ArchiveGridDownloadPageLogic>(ArchiveGridDownloadPageLogic(), permanent: true);
  @override
  ...
  GridGallery galleryBuilder(BuildContext context, ArchiveDownloadedData archive, bool inEditMode) {
    return GridGallery(
      ...
      parseFromBot: archiveDownloadService.archiveDownloadInfos[archive.gid]?.parseSource ==
      ...
      onLongPress:
          inEditMode ? null : () => logic.handleLongPressOrSecondaryTapItem(archive, context),
      onSecondTap:
          inEditMode ? null : () => logic.handleLongPressOrSecondaryTapItem(archive, context),
