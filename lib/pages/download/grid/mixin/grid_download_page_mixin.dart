      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: onTapTitle,
            child:
                Center(child: Text(title.breakWord, maxLines: 1, overflow: TextOverflow.ellipsis)),
          ),
        ],
      ),
    );
              ...
              builder: (_) {
                ...
                return superResolutionInfo == null
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                          color: UIConfig.backGroundColor(context),
                          borderRadius: superResolutionInfo.status == SuperResolutionStatus.success
                              ? null
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            decoration: superResolutionInfo.status == SuperResolutionStatus.paused
          ...
          if (isOriginal)
            Container(
              ...
              child: Text('original'.tr,
                  style: TextStyle(fontSize: 9, color: UIConfig.onBackGroundColor(context))),
            ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                  color: UIConfig.downloadPageGridViewGroupBackGroundColor(context),
                  borderRadius: BorderRadius.circular(8)),
                        ...
                        Expanded(
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                  child: _buildInnerImage(1)
                                      .marginOnly(left: UIConfig.downloadPageGridViewGroupPadding)),
                            ],
                          ),
                        ),
          ...
          Text('$groupName${contentSize == null ? '' : '(' + contentSize.toString() + ')'}',
