...
import 'package:jhentai/pages/search/mobile_v2/search_page_mobile_v2_state.dart';
  ...
  AppBar? buildAppBar(BuildContext context) {
    return AppBar(
      leading: GestureDetector(
        ...
        onLongPress: () =>
            untilRoute(currentRoute: Routes.mobileV2Search, predicate: (route) => route.isFirst),
      ),
      ...
      bottom: PreferredSize(
          ...
          preferredSize: const Size(double.infinity, UIConfig.mobileV2SearchBarHeight)),
