...
import 'package:jhentai/pages/details/comment/eh_comment.dart';
...
import 'package:jhentai/widget/eh_gallery_detail_dialog.dart';
...
class DetailsPage extends StatelessWidget with Scroll2TopPageMixin {
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        margin: const EdgeInsets.only(
            top: 12, left: UIConfig.detailPagePadding, right: UIConfig.detailPagePadding),
        child: Row(
          children: [
            _buildCover(context),
  ...
  Widget _buildCover(BuildContext context) {
    return GetBuilder<DetailsPageLogic>(
      ...
      builder: (_) {
        GalleryImage? cover =
            state.galleryDetails?.cover ?? state.gallery?.cover ?? state.galleryMetadata?.cover;
              ...
              toolbar.buttonItems?.add(
                ContextMenuButtonItem(
                  ...
                  onPressed: () {
                    ...
                    newSearch(
                      keyword: editableTextState.currentTextEditingValue.selection
          ...
          builder: (_) {
            if (state.galleryDetails == null && state.galleryMetadata == null) {
              return const AnimatedSwitcher(
                  duration: Duration(milliseconds: UIConfig.detailsPageAnimationDuration),
                  child: SizedBox());
            }
  ...
  Widget _buildRatingBar(BuildContext context) {
    return GetBuilder<DetailsPageLogic>(
      ...
      builder: (_) {
        ...
        double? rating =
            state.galleryDetails?.rating ?? state.gallery?.rating ?? state.galleryMetadata?.rating;
  ...
  Widget buildDivider() {
    return const SliverPadding(
      padding: EdgeInsets.only(
          top: 16, left: UIConfig.detailPagePadding, right: UIConfig.detailPagePadding),
            ...
            child: FadeIn(
              child: TextButton(
                ...
                onPressed: () => toRoute(
                  Routes.details,
                  arguments:
                      DetailsPageArgument(galleryUrl: state.galleryDetails!.newVersionGalleryUrl!),
                  offAllBefore: false,
      ...
      builder: (_) {
        ...
        return LoadingStateIndicator(
          ...
          idleWidgetBuilder: () => IconTextButton(
            ...
            onLongPress: disabled || preferenceSetting.enableDefaultFavorite.isFalse
                ? null
  ...
  Widget _buildSimilarButton(BuildContext context) {
    return GetBuilder<DetailsPageLogic>(
      ...
      builder: (_) {
        bool disabled =
            state.gallery == null && state.galleryDetails == null && state.galleryMetadata == null;
    ...
    return GetBuilder<DetailsPageLogic>(
      ...
      builder: (_) {
        ...
        return IconTextButton(
          ...
          onPressed:
              disabled || state.galleryDetails!.torrentCount == '0' ? null : logic.handleTapTorrent,
        );
      },
    );
  }
    ...
    return tags
        .map(
          (tag) => EHTag(
            tag: tag,
            onTap: (tag) => newSearch(
                keyword: '${tag.tagData.namespace}:"${tag.tagData.key}\$"', forceNewRoute: true),
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) => EHComment(
                        ...
                        onVoted: (bool isVotingUp, String score) => logic.onCommentVoted(
                            state.galleryDetails!.comments[index], isVotingUp, score),
      ...
      builder: (_) => GetBuilder<DetailsPageLogic>(
        ...
        builder: (_) => SliverPadding(
          padding: const EdgeInsets.only(
              top: 36, left: UIConfig.detailPagePadding, right: UIConfig.detailPagePadding),
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      GalleryImage? downloadedImage = galleryDownloadService
                          .galleryDownloadInfos[state.galleryUrl.gid]?.images[index];
