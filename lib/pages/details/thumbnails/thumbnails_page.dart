...
import 'package:jhentai/pages/details/thumbnails/thumbnails_page_logic.dart';
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                GalleryImage? downloadedImage = galleryDownloadService
                    .galleryDownloadInfos[logic.detailsPageState.galleryDetails!.galleryUrl.gid]
                    ...
                    Expanded(
                      child: Center(
                        child: GestureDetector(
                          onTap: () => logic.detailsPageLogic
                              .goToReadPage(state.absoluteIndexOfThumbnails[index]),
                          child: LayoutBuilder(
