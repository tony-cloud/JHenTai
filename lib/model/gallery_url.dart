import 'package:jhentai/exception/internal_exception.dart';
...
class GalleryUrl {
  ...
  const GalleryUrl({required this.isEH, required this.gid, required this.token})
  ...
  String get url =>
      isEH ? 'https://e-hentai.org/g/$gid/$token/' : 'https://exhentai.org/g/$gid/$token/';
