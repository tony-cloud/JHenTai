...
import 'package:jhentai/pages/details/thumbnails/thumbnails_page.dart';
import 'package:jhentai/pages/download/download_base_page.dart';
import 'package:jhentai/pages/download_search/download_search_page.dart';
import 'package:jhentai/pages/gallery_image/gallery_image_page.dart';
import 'package:jhentai/pages/gallerys/dashboard/dashboard_page.dart';
import 'package:jhentai/pages/history/history_page.dart';
import 'package:jhentai/pages/gallerys/simple/gallerys_page.dart';
import 'package:jhentai/pages/layout/desktop/desktop_home_page.dart';
import 'package:jhentai/pages/lock_page.dart';
import 'package:jhentai/pages/popular/popular_page.dart';
import 'package:jhentai/pages/ranklist/ranklist_page.dart';
import 'package:jhentai/pages/read/read_page.dart';
import 'package:jhentai/pages/search/mobile_v2/search_page_mobile_v2.dart';
import 'package:jhentai/pages/search/quick_search/quick_search_page.dart';
import 'package:jhentai/pages/setting/about/setting_about_page.dart';
...
import 'package:jhentai/pages/setting/performance/setting_performace_page.dart';
import 'package:jhentai/pages/setting/preference/block_rule/blocking_rule_page.dart';
import 'package:jhentai/pages/setting/preference/setting_preference_page.dart';
import 'package:jhentai/pages/setting/read/setting_read_page.dart';
import 'package:jhentai/pages/setting/security/setting_security_page.dart';
import 'package:jhentai/pages/setting/setting_page.dart';
import 'package:jhentai/pages/setting/style/setting_style_page.dart';
import 'package:jhentai/pages/home_page.dart';
import 'package:jhentai/pages/watched/watched_page.dart';
